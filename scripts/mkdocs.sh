...
export ABLE_WORKFLOW_COPIER_REPO="https://github.com/NEU-ABLE-LAB/able-workflow-copier"
export ABLE_WORKFLOW_COPIER_DOCS="http://localhost:8001"
export ABLE_WORKFLOW_MODULE_COPIER_REPO="https://github.com/NEU-ABLE-LAB/able-workflow-module-copier"
export ABLE_WORKFLOW_MODULE_COPIER_DOCS="http://localhost:8002"
export ABLE_WORKFLOW_ETL_COPIER_REPO="https://github.com/NEU-ABLE-LAB/able-workflow-etl-copier"
export ABLE_WORKFLOW_ETL_COPIER_DOCS="http://localhost:8003"
export ABLE_WORKFLOW_RULE_COPIER_REPO="https://github.com/NEU-ABLE-LAB/able-workflow-rule-copier"
