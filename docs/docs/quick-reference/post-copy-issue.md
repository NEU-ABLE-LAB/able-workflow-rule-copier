...
Copy-paste the markdown below into a github issue for what should be done after you create a rule template.

- TODO-copier-package Render this jinja with copier into a directory that is git ignored so the user can copy-paste the rendered template as an issue.
